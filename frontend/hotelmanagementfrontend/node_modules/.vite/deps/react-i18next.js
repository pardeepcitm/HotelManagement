...
var hasChildren = (node, checkLength) => {
  ...
  if (!node)
    return false;
  const base = (_b = (_a = node.props) == null ? void 0 : _a.children) != null ? _b : node.children;
  if (checkLength)
...
var getChildren = (node) => {
  ...
  if (!node)
    return [];
  const children = (_b = (_a = node.props) == null ? void 0 : _a.children) != null ? _b : node.children;
  return ((_c = node.props) == null ? void 0 : _c.i18nIsDynamicList) ? getAsArray(children) : children;
};
...
var nodesToString = (children, i18nOptions, i18n, i18nKey) => {
  ...
  const keepArray = (i18nOptions == null ? void 0 : i18nOptions.transSupportBasicHtmlNodes) ? (_a = i18nOptions.transKeepBasicHtmlNodesFor) != null ? _a : [] : [];
...
var renderNodes = (children, knownComponentsMap, targetString, i18n, i18nOptions, combinedTOpts, shouldUnescape) => {
  ...
  if (!children && !knownComponentsMap && !emptyChildrenButNeedsHandling && !shouldUnescape)
    return [targetString];
  const data = knownComponentsMap != null ? knownComponentsMap : {};
  const getData = (childs) => {
    const childrenArray = getAsArray(childs);
    childrenArray.forEach((child) => {
      if (isString(child))
...
function Trans({
  ...
  const mergedShouldUnescape = shouldUnescape != null ? shouldUnescape : transDefaultProps == null ? void 0 : transDefaultProps.shouldUnescape;
  ...
  const useAsParent = parent != null ? parent : reactI18nextOptions.defaultTransParent;
...
var composeInitialProps = (ForComponent) => async (ctx) => {
  var _a, _b;
  const componentsInitialProps = (_b = await ((_a = ForComponent.getInitialProps) == null ? void 0 : _a.call(ForComponent, ctx))) != null ? _b : {};
...
var getInitialProps = () => {
  var _a, _b;
  const i18n = getI18n();
  const namespaces = (_b = (_a = i18n.reportNamespaces) == null ? void 0 : _a.getUsedNamespaces()) != null ? _b : [];
  const ret = {};
